...
export const AccountSetupStepOneSchema = z.object({
  username: z
    .string()
  ...
  inAppName: z
    ...
    .regex(
      /^[a-zA-Z0-9\s\-_]+$/,
      "In-app name can only contain letters, numbers, spaces, hyphens, and underscores",
    ),
  profession: z
    .string()
...
export type AccountSetupStepOneInput = z.infer<typeof AccountSetupStepOneSchema>;
