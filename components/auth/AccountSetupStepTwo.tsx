...
interface StepTwoProps {
  defaultValues?: AccountSetupStepTwoInput;
  loading: boolean;
  onBack: () => void;
  onComplete: (data: AccountSetupStepTwoInput) => void;
}

export const AccountSetupStepTwo: React.FC<StepTwoProps> = ({
  defaultValues,
  loading,
  onBack,
  onComplete,
