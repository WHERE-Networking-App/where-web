...
export const SignUp: React.FC = () => {
  ...
  const handleSubmit = async (e: React.SubmitEvent<HTMLFormElement>) => {
    ...
    // Call the signup API
    const { data, error } = await apiClient<SignUpResponse>(
      "/api/auth/signup",
      {
        method: "POST",
    ...
    if (error || !data) {
      setServerError(error ?? "Sign up failed. Please try again.");
      setLoading(false);
      return;
    }
    ...
    // Redirect to account setup (backend identifies user via JWT)
